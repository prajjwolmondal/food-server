...
class AdditionalInfoForm(FlaskForm):
    ...
    cuisine_preferences = SelectMultipleField('Select your top 5 cuisines:', choices=cuisine_list, validators=[InputRequired()], render_kw=({'multiple': 'multiple', 'data-max-options': '5', 'data-selected-text-format':'count > 3', 'data-live-search': 'true'}))
